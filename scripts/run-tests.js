// Standalone fast unit test runner for KasuwaShield
import assert from "node:assert";
import { calculateProtection, evaluateMarketQuality } from "../packages/risk-engine/src/index.js";
import { DEFAULT_RISK_POLICY } from "../packages/shared/src/index.js";
import {
...
async function runAllTests() {
  console.log("==================================================");
  console.log("  KASUWASHIELD ZERO-DEPENDENCY UNIT TEST SUITE");
  console.log("==================================================");
  ...
  test("Calculates 30% downside protection for $500 BTC exposure correctly", () => {
    const params = {
      exposureUSD: 500,
  ...
  console.log("\n[2] EIP-7702 DELEGATION & SESSION KEY TESTS:");
  const mockEOA = "0x71C9999999999999999999999999999999999A2B";
  const mockExecutor = "0x8F31111111111111111111111111111111114C1C";
