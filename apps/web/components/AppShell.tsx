...
import { Shield, Zap, Activity, Radio, AlertTriangle, PlayCircle } from "lucide-react";
      ...
      <header className="border-b border-slate-800/80 bg-[#0a0f1d]/95 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-[96rem] mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6 text-xs font-mono">
            ...
            <div className="flex items-center space-x-1.5 bg-amber-500/10 border border-amber-500/30 px-2.5 py-1 rounded text-amber-300 font-bold">
              <span>MODE:</span>
              <span className="text-amber-200">DEMO SIMULATION</span>
            </div>
          </div>
