...
export function RiskEngineChart({
  ...
  return (
    <div className="bg-[#0b101d] rounded-xl p-5 border border-slate-800 space-y-4 shadow-xl">
      {/* Panel Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800/80 pb-3">
        <div>
          <div className="flex items-center space-x-2">
            <Activity className="w-5 h-5 text-emerald-400" />
            <h2 className="text-base font-extrabold tracking-wider uppercase text-white font-mono">
              DETERMINISTIC RISK ENGINE
            </h2>
          </div>
          <p className="text-xs text-slate-400 font-mono mt-0.5">
            Programmable downside protection • Continuous spot price vs. strike threshold evaluation
          </p>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between text-xs font-mono bg-slate-900/90 p-3 rounded-lg border border-slate-800 text-slate-400">
        <div>
