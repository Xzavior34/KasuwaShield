...
export function useRiskEngineState() {
  ...
  // Audit Ledger (Real Somnia Shannon testnet mined transactions; stress simulation appends test runs)
  const [auditLedger, setAuditLedger] = useState<AuditRecord[]>([
    {
      ...
      event: "DREAMDEX_FILL",
      action: "IOC_BUY_NO",
      contract: "0x476b...270B (BTC Binary)",
      riskScore: 28,
    ...
    },
    {
      id: "aud-2",
      time: "18:47:00",
      event: "SETTLEMENT_ROLL",
      action: "AUTO_ROLL_#1",
      contract: "0x80Ac...c69c (Executor)",
      riskScore: 34,
